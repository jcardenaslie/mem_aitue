{'readme': 
{'experiment_name': 'experimento 2.2', 
...
'personas_predictors': Index(['is_apellido1', 'is_appelido2', 'is_celular', 'is_direccion', 'is_fnac',
		...
		'Edificio Junge'],
		dtype='object'), 
	  'personas_dummies_shape': (2251, 173), 
	  'personas_negocio': (714,), 
	  'personas_nonegocio': (1537,), 
	  'x_train_shape': (1575, 173), 
	  'y_train_shape': (1575,), 
	  'x_test_shape': (676, 173), 
	  'y_test_shape': (676,), 
	  'model': {
		  'PRT_LR': {
				'conf_matrix': array([[384,  83],
				[ 39, 170]], dtype=int64), 
				'cla_report': '             
						precision    recall  f1-score   support\n\n      
				False       0.91      0.82      0.86       467\n       
				True       0.67      0.81      0.74       209\n\navg / 
				total       0.83      0.82      0.82       676\n'}, 
		   'KNN': {
				'name': 'KNN', 
		   ...
		   'DT': {
				'name': 'DT', 
				'best_estimator': DecisionTreeClassifier(class_weight=None, criterion='gini', max_depth=13,
					max_features=27, max_leaf_nodes=None,
					min_impurity_decrease=0.0, min_impurity_split=None,
					min_samples_leaf=7, min_samples_split=2,
					min_weight_fraction_leaf=0.0, presort=False, random_state=None,
					splitter='best'), 
					'best_score': 0.8382940915148823, 
					'conf_matrix': array([[425,  42],
			   [ 86, 123]], dtype=int64), 
			   'cla_report': '             
						precision    recall  f1-score   support\n\n      
			   False       0.83      0.91      0.87       467\n      
			   True       0.75      0.59      0.66       209\n\navg / 
			   total       0.81      0.81      0.80       676\n'}, 
		   'URF': {
			   'name': 'URF', 
			   'best_estimator': RandomForestClassifier(bootstrap=True, class_weight=None, criterion='entropy',
					...
					warm_start=False), 
				'best_score': 0.8449577965348734, 
				'conf_matrix': array([[442,  25],
			   [ 93, 116]], dtype=int64), 
			   'cla_report': '             
						precision    recall  f1-score   support\n\n      
			   False       0.83      0.95      0.88       467\n       
			   True       0.82      0.56      0.66       209\n\navg / 
			   total       0.83      0.83      0.81       676\n'}, 
		   'BRF': {
			   'conf_matrix': array([[382,  85],
			   [ 49, 160]], dtype=int64), 
			   'cla_report': '             
		   ...
		   'SVM': {
			   ...
			   'best_estimator': SVC(C=10, cache_size=200, class_weight=None, coef0=0.0,
				...
				'conf_matrix': array([[410,  57],
			   [ 74, 135]], dtype=int64), 'cla_report': '             
							precision    recall  f1-score   support\n\n      
				   False       0.85      0.88      0.86       467\n       
				   True       0.70      0.65      0.67       209\n\navg / 
				   total       0.80      0.81      0.80       676\n'}}, 
	   'time_exec': 421.2400085926056}}