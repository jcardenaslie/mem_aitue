{'readme': {'experiment_name': 'Altos del Valle NN base_medini_isrec', 'experiment_dataset': 'personas_cotizacion6.csv', 'personas_shape': (6184, 36), 'personas_columns': ['Unnamed: 0', 'is_apellido1', 'is_appelido2', 'is_celular', 'is_direccion', 'is_fnac', 'is_nombre', 'is_nombrecompleto', 'is_nrofam', 'is_profesion', 'is_recontacto', 'is_telefono', 'loc_comuna', 'loc_provincia', 'loc_region', 'max_rango_edad', 'mean_cot_bod', 'mean_cot_depto', 'mean_cot_esta', 'mean_cot_estu', 'medio_inicial', 'negocio', 'nro_cot_bod', 'nro_cot_depto', 'nro_cot_esta', 'nro_cot_estu', 'nro_proyectos', 'profesion', 'rut', 'sexo', 'tipo_cliente', 'Altos del Valle', 'Edificio Urban 1470', 'San Andres Del Valle', 'Edificio Mil610', 'Edificio Junge'], 'personas_after_drop_columns': Index(['is_apellido1', 'is_appelido2', 'is_celular', 'is_direccion', 'is_fnac',
      ...
      dtype='object'), 'personas_predictors_shape': (125, 31), 'personas_predictors': Index(['is_apellido1', 'is_appelido2', 'is_celular', 'is_direccion', 'is_fnac',
       'is_nombre', 'is_nombrecompleto', 'is_nrofam', 'is_profesion',
       'is_telefono', 'loc_comuna', 'loc_provincia', 'loc_region',
       'mean_cot_bod', 'mean_cot_depto', 'mean_cot_esta', 'mean_cot_estu',
       'nro_cot_bod', 'nro_cot_depto', 'nro_cot_esta', 'nro_cot_estu',
       ...
       'San Andres Del Valle', 'Edificio Mil610', 'Edificio Junge',
       'profesion', 'medio_inicial', 'is_recontacto'],
      dtype='object'), 'personas_dummies_shape': (125, 186), 'personas_negocio': (59,), 'personas_nonegocio': (66,), 'x_train_shape': (87, 186), 'y_train_shape': (87,), 'x_test_shape': (38, 186), 'y_test_shape': (38,), 'model': {'PRT_BLR': {'conf_matrix': array([[15,  6],
       [ 5, 12]], dtype=int64), 'cla_report': '             precision    recall  f1-score   support\n\n      False       0.75      0.71      0.73        21\n       True       0.67      0.71      0.69        17\n\navg / total       0.71      0.71      0.71        38\n'}, 'KNN': {'name': 'KNN', 'best_estimator': KNeighborsClassifier(algorithm='auto', leaf_size=30, metric='minkowski',
           metric_params=None, n_jobs=1, n_neighbors=2, p=2,
           weights='uniform'), 'best_score': 0.752, 'conf_matrix': array([[21,  0],
       [ 8,  9]], dtype=int64), 'cla_report': '             precision    recall  f1-score   support\n\n      False       0.72      1.00      0.84        21\n       True       1.00      0.53      0.69        17\n\navg / total       0.85      0.79      0.77        38\n'}, 'PCAKNN': {'name': 'PCAKNN', 'best_estimator': LogisticRegression(C=268.2695795279727, class_weight=None, dual=False,
          fit_intercept=True, intercept_scaling=1, max_iter=100,
          multi_class='ovr', n_jobs=1, penalty='l2', random_state=None,
          solver='liblinear', tol=0.0001, verbose=0, warm_start=False), 'best_score': 0.768, 'conf_matrix': array([[14,  7],
       [ 2, 15]], dtype=int64), 'cla_report': '             precision    recall  f1-score   support\n\n      False       0.88      0.67      0.76        21\n       True       0.68      0.88      0.77        17\n\navg / total       0.79      0.76      0.76        38\n'}, 'ULR': {'conf_matrix': array([[15,  6],
       [ 3, 14]], dtype=int64), 'cla_report': '             precision    recall  f1-score   support\n\n      False       0.83      0.71      0.77        21\n       True       0.70      0.82      0.76        17\n\navg / total       0.77      0.76      0.76        38\n'}, 'BLR': {'conf_matrix': array([[15,  6],
